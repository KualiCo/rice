...
public class DefaultExpressionEvaluator implements ExpressionEvaluator {
    ...
    static {
        try {
            isAssignableFrom = ExpressionFunctions.class.getDeclaredMethod("isAssignableFrom",
            ...
            listContains = ExpressionFunctions.class.getDeclaredMethod("listContains",
            ...
            hasPermTmpl = ExpressionFunctions.class.getDeclaredMethod("hasPermTmpl",
                    new Class[] {String.class, String.class, Map.class, Map.class});
    ...
    public String parseExpression(String exp, List<String> controlNames, Map<String, Object> context) {
        ...
        exp = cleanUpExpression(exp);

        // Evaluate server side method calls and constants, and place them in a map to be replaced later
        Map<String, String> serverEvaluations = evaluateServerSideVariables(exp, context);
        ...
        conditionJs = replaceWithJsEquivalents(conditionJs);

        // Replace server evaluations in js string with evaluated value
    ...
    /**
     * Trim, remove expression tokens, and replace common symbols for consistency in parsing and output.
     *
    ...
    /**
     * Replace springEL specific functionality with js equivalents.
     *
     * @param conditionJs the original expression
     * @return the modified expression with js equivalent function calls
     */
    private String replaceWithJsEquivalents(String conditionJs) {
        ...
        conditionJs = conditionJs.replaceAll("\\s?(?i:#emptyList)\\((.*?)\\)", "emptyList($1)");
    ...
    protected void evaluateCurrentStack(String stack, List<String> controlNames) {
        ...
        if (!(stack.equals("==") || stack.equals("!=") || stack.equals(">") || stack.equals("<") || stack.equals(">=")
                || stack.equals("<=") || stack.equalsIgnoreCase("ne") || stack.equalsIgnoreCase("eq") || stack
                .equalsIgnoreCase("gt") || stack.equalsIgnoreCase("lt") || stack.equalsIgnoreCase("lte") || stack
                .equalsIgnoreCase("gte") || stack.equalsIgnoreCase("matches") || stack.equalsIgnoreCase("null") || stack
                .equalsIgnoreCase("false") || stack.equalsIgnoreCase("true") || stack.equalsIgnoreCase("and") || stack
                .equalsIgnoreCase("or") || stack.startsWith("#") || stack.equals("!") || stack.startsWith("'") || stack
                .endsWith("'"))) {
