    ...
    public void testStaticWeaving() {
        ...
        final Set<Class<?>> notWeaved = Stream.concat(
                findNotWeaved(Stream.of(persistenceObject, persistenceEntity).collect(Collectors.toSet()),
                        entityScanner.findCandidateComponents(DocumentAttachment.class.getPackage().getName()),
                        entityScanner.findCandidateComponents(DocumentBase.class.getPackage().getName()),
                        entityScanner.findCandidateComponents(MaintenanceLock.class.getPackage().getName()),
                        entityScanner.findCandidateComponents(Message.class.getPackage().getName()),
                        mscScanner.findCandidateComponents(DocumentAttachment.class.getPackage().getName()),
                        mscScanner.findCandidateComponents(DocumentBase.class.getPackage().getName()),
                        mscScanner.findCandidateComponents(MaintenanceLock.class.getPackage().getName()),
                        mscScanner.findCandidateComponents(Message.class.getPackage().getName())),
                findNotWeaved(Collections.singleton(persistenceObject),
                        embeddableScanner.findCandidateComponents(DocumentAttachment.class.getPackage().getName()),
                        embeddableScanner.findCandidateComponents(DocumentBase.class.getPackage().getName()),
                        embeddableScanner.findCandidateComponents(MaintenanceLock.class.getPackage().getName()),
                        embeddableScanner.findCandidateComponents(Message.class.getPackage().getName())))
