...
public class TestDataDictionaryService implements DataDictionaryService {
    ...
    /**
     * @see org.kuali.rice.krad.service.DataDictionaryService#setAdditionalDictionaryFiles(java.util.Map)
     */
    @Override
    public void setAdditionalDictionaryFiles(Map<String, List<String>> additionalDictionaryFiles) throws IOException {
        throw new UnsupportedOperationException("Test DD is statically defined");
    }

    /**
     * @see org.kuali.rice.krad.service.DataDictionaryService#addDataDictionaryLocations(java.lang.String, java.util.List)
     */
    @Override
    ...
    public String getDocumentLabelByTypeName(String documentTypeName) {
        ...
        if (StringUtils.isNotBlank(documentTypeName)) {
            throw new UnsupportedOperationException("KEW not supported in this envionrment");
        }
        return label;
    }
