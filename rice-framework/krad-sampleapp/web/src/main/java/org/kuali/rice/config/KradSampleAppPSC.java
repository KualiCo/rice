...
/**
 * Holds the property source for all of the different properties needed for starting up the KRAD Sample App.
 * 
 * @author Kuali Rice Team (rice.collab@kuali.org)
 */
@Configuration
@Import({ KradSampleAppProjectConfig.class, JdbcPropertyLocationsConfig.class, SourceSqlPropertyLocationsConfig.class, IngestXmlPropertyLocationsConfig.class,
		PropertiesLocationServiceConfig.class, DefaultPropertiesServiceConfig.class })
public class KradSampleAppPSC implements PropertySourceConfig {
	...
	public PropertySource<?> propertySource() {
		...
		// -Dproperties.resolve=false turns off resolve
		...
		Config rootCfg = RiceConfigUtils.getRootConfig(properties, KRAD_SAMPLE_APP_CONFIG, servletContext);

		// Make sure ConfigContext.getCurrentContextConfig() return's this rootCfg object
