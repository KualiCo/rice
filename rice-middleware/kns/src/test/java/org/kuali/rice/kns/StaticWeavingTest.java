...
public class StaticWeavingTest {
    ...
    private static final String KRAD_PACKAGE = "org.kuali.rice.krad";
    private static final String KNS_PACKAGE = "org.kuali.rice.kns";
    ...
    public void testStaticWeaving() {
        ...
        final Set<Class<?>> notWeaved = Stream.concat(
                findNotWeaved(Stream.of(persistenceObject, persistenceEntity).collect(Collectors.toSet()),
                        entityScanner.findCandidateComponents(KRAD_PACKAGE),
                        entityScanner.findCandidateComponents(KNS_PACKAGE),
                        mscScanner.findCandidateComponents(KRAD_PACKAGE),
                        mscScanner.findCandidateComponents(KNS_PACKAGE)),

                findNotWeaved(Collections.singleton(persistenceObject),
                        embeddableScanner.findCandidateComponents(KRAD_PACKAGE),
                        embeddableScanner.findCandidateComponents(KNS_PACKAGE)))
