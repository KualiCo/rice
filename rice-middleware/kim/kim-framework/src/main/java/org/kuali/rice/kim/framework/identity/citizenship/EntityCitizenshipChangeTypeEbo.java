 ...
 */
public interface EntityCitizenshipChangeTypeEbo extends CodedAttributeContract, ExternalizableBusinessObject {
    
    /**
     * This the name for the EntityCitizenshipChangeType.  This can be null or a blank string.
     *
     * @return the name of the EntityCitizenshipChangeType
     */
    String getName();

    /**
     * This the sort code for the EntityCitizenshipChangeType.  This can be null or a blank string.
     *
     * @return the sort code of the EntityCitizenshipChangeType
     */
    String getSortCode();
