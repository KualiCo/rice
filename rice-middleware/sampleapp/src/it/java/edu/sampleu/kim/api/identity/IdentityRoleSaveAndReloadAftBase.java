 ...
 */
public abstract class IdentityRoleSaveAndReloadAftBase extends AdminTmplMthdAftNavBase {
    ...
    public void testIdentityRoleSaveAndReloadBookmark(JiraAwareFailable failable) throws Exception {
        testIdentityRoleSaveAndReload();
        passed();
    }

    public void testIdentityRoleSaveAndReloadNav(JiraAwareFailable failable) throws Exception {
        testIdentityRoleSaveAndReload();
        passed();
    }
}
